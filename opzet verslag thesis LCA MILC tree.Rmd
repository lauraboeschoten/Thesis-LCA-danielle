...
Especially compared to survey data, there is not much statistical theories for assessing the uncertainty of register-based statistics(Holt 2007; in Zhang 2012). Zhang (2012) developed a Total Survey Error framework for administrative datasources. 
...
How many imputations? check equation EMOS slides, recommendations Boeschoten (2017). 
...
basic.sim4 <- poLCA.simdata(N=5000,nclass=2,ndv=2,P=c(0.4, 0.3, 0.3), probs= probs3)
basic.sim4$probs
```
